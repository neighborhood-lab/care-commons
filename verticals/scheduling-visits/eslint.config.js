...
export default [
  ...
  promise.configs['flat/recommended'],
  {
    ...
    rules: {
      ...
      'sonarjs/different-types-comparison': 'off', // Allow loose type comparisons in domain logic
      'sonarjs/no-nested-conditional': 'off', // Allow nested conditionals in complex logic
      'sonarjs/todo-tag': 'off', // Allow TODO comments
