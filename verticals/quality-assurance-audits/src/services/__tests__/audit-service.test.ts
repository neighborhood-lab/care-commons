    ...
    const mockFindings: AuditFinding[] = [
      {
        ...
        requiredCorrectiveAction: 'Complete documentation',
        locationDescription: 'All departments',
        status: 'OPEN',
        observedAt: new Date('2024-02-05'),
        observedBy: '00000000-0000-0000-0000-000000000005',
        observedByName: 'Test User',
        targetResolutionDate: new Date('2024-03-05'),
