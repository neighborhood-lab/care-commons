...
function setupRoutes(app, db) {
    ...
    const organizationRouter = (0, organizations_1.createOrganizationRouter)(db);
    ...
    const userRepository = new core_1.UserRepository(db);
    const carePlanService = new care_plans_tasks_1.CarePlanService(carePlanRepository, permissionService, userRepository);
