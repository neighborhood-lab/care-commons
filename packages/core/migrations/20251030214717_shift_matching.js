...
async function up(knex) {
  ...
  `);
    await knex.schema.createTable('caregiver_preference_profiles', (table) => {
        ...
        table.uuid('organization_id').notNullable();
        table.jsonb('preferred_days_of_week');
        table.jsonb('preferred_time_ranges');
        table.jsonb('preferred_shift_types');
...
//# sourceMappingURL=20251030214717_shift_matching.js.map