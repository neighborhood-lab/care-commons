...
export async function up(knex: Knex): Promise<void> {
  ...
  // Add constraints to evv_state_config
  await knex.raw(`
  ...
  // Add constraints to evv_revisions
  await knex.raw(`
  ...
  // Add constraints to evv_access_log
  await knex.raw(`
  ...
  // Add constraints to state_aggregator_submissions
  await knex.raw(`
  ...
  // Indexes for state_aggregator_submissions
  ...
  // Add constraints to evv_exception_queue
  await knex.raw(`
  ...
  // Indexes for evv_exception_queue
