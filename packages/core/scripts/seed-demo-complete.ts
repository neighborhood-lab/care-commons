 ...
 * 
 * Seeds comprehensive demo data for development and testing:
 * - Sample program (Personal Care Services)
 * - Sample clients (5 with detailed profiles)
 * - Sample caregivers (5 with credentials and availability)
 * 
...
async function seedDatabase() {
  ...
  try {
    await db.transaction(async (client) => {
      // Fetch existing organization, branch, and user (created by db:seed)
