...
export const ALL_STATES_CONFIG: Record<StateCode, StateComplianceConfig> = {
  ...
  'GA': {
    ...
    backgroundScreening: {
      ...
      validityMonths: 60,
      rescreeningFrequencyMonths: 60,
      stateRegistries: ['GA Nurse Aide Registry'],
      disqualifyingOffenses: ['violent_crimes', 'elder_abuse'],
      requiresLiveScan: false,
    },
    caregiverCredentialing: {
    ...
    regulatory: {
      primaryAgency: 'Georgia Department of Community Health',
      agencyWebsite: 'https://dch.georgia.gov',
      licenseTypes: ['Home Health Agency'],
      keyRegulations: ['GA Comp. R. & Regs. 111-8-70'],
      auditFrequencyMonths: 36,
      incidentReportingHours: 24,
      seriousIncidentReportingHours: 2,
      clientRightsPostingRequired: true,
      medicaidWaiverPrograms: ['Community Care Services Program', 'NOW/COMP Waiver'],
    },
    lastUpdated: '2025-11-12',
  },
  ...
  'HI': {
    ...
    backgroundScreening: {
      ...
      validityMonths: 60,
      rescreeningFrequencyMonths: 60,
      stateRegistries: ['HI Nurse Aide Registry'],
      disqualifyingOffenses: ['violent_crimes', 'elder_abuse'],
      requiresLiveScan: false,
    },
    caregiverCredentialing: {
    ...
    regulatory: {
      primaryAgency: 'Hawaii Department of Health',
      agencyWebsite: 'https://health.hawaii.gov',
      licenseTypes: ['Home Health Agency'],
      keyRegulations: ['HAR Title 11, Chapter 94'],
      auditFrequencyMonths: 36,
      incidentReportingHours: 24,
      seriousIncidentReportingHours: 4,
      clientRightsPostingRequired: true,
      medicaidWaiverPrograms: ['1915(c) HCBS Waiver'],
    },
    lastUpdated: '2025-11-12',
    notes: 'Island geography creates EVV challenges; more flexible geofencing.',
  },
  ...
  'ID': {
    ...
    backgroundScreening: {
      ...
      validityMonths: 60,
      rescreeningFrequencyMonths: 60,
      stateRegistries: ['ID Nurse Aide Registry'],
      disqualifyingOffenses: ['violent_crimes', 'elder_abuse'],
      requiresLiveScan: false,
    },
    caregiverCredentialing: {
    ...
    regulatory: {
      primaryAgency: 'Idaho Department of Health and Welfare',
      agencyWebsite: 'https://healthandwelfare.idaho.gov',
      licenseTypes: ['Home Health Agency'],
      keyRegulations: ['IDAPA 16.03.07'],
      auditFrequencyMonths: 36,
      incidentReportingHours: 24,
      seriousIncidentReportingHours: 2,
      clientRightsPostingRequired: true,
      medicaidWaiverPrograms: ['Aged and Disabled Waiver', 'DD Waiver'],
    },
    lastUpdated: '2025-11-12',
  },
  ...
  'IL': {
    ...
    backgroundScreening: {
      ...
      validityMonths: 60,
      rescreeningFrequencyMonths: 60,
      stateRegistries: ['IL Nurse Aide Registry', 'IL Health Care Worker Registry'],
      disqualifyingOffenses: ['violent_crimes', 'elder_abuse', 'financial_crimes'],
      requiresLiveScan: false,
    },
    caregiverCredentialing: {
      nurseAideRegistryRequired: true,
    ...
    regulatory: {
      ...
      agencyWebsite: 'https://dph.illinois.gov',
      licenseTypes: ['Home Health Agency', 'Home Services Agency'],
      keyRegulations: ['210 ILCS 55', '77 IL Admin. Code 245'],
      auditFrequencyMonths: 36,
      incidentReportingHours: 24,
      seriousIncidentReportingHours: 2,
      clientRightsPostingRequired: true,
      medicaidWaiverPrograms: ['Home and Community-Based Services Waiver'],
    },
    lastUpdated: '2025-11-12',
    notes: 'IL has Health Care Worker Registry in addition to Nurse Aide Registry. Higher training hours required.',
  },
  ...
  'IN': {
    ...
    backgroundScreening: {
      ...
      validityMonths: 60,
      rescreeningFrequencyMonths: 60,
      stateRegistries: ['IN Nurse Aide Registry'],
      disqualifyingOffenses: ['violent_crimes', 'elder_abuse'],
      requiresLiveScan: false,
    },
    caregiverCredentialing: {
    ...
    regulatory: {
      primaryAgency: 'Indiana State Department of Health',
      agencyWebsite: 'https://www.in.gov/health',
      licenseTypes: ['Home Health Agency'],
      keyRegulations: ['410 IAC 17-16'],
      auditFrequencyMonths: 36,
      incidentReportingHours: 24,
      seriousIncidentReportingHours: 2,
      clientRightsPostingRequired: true,
      medicaidWaiverPrograms: ['Aged and Disabled Waiver', 'Traumatic Brain Injury Waiver'],
    },
    lastUpdated: '2025-11-12',
  },
  ...
  'IA': {
    ...
    backgroundScreening: {
      ...
      validityMonths: 60,
      rescreeningFrequencyMonths: 60,
      stateRegistries: ['IA Nurse Aide Registry', 'IA Abuse Registry'],
      disqualifyingOffenses: ['violent_crimes', 'elder_abuse'],
      requiresLiveScan: false,
    },
    caregiverCredentialing: {
    ...
    regulatory: {
      primaryAgency: 'Iowa Department of Inspections and Appeals',
      agencyWebsite: 'https://dia.iowa.gov',
      licenseTypes: ['Home Health Agency'],
      keyRegulations: ['Iowa Admin. Code 481-51'],
      auditFrequencyMonths: 36,
      incidentReportingHours: 24,
      seriousIncidentReportingHours: 2,
      clientRightsPostingRequired: true,
      medicaidWaiverPrograms: ['HCBS Elderly Waiver', 'HCBS Health and Disability Waiver'],
    },
    lastUpdated: '2025-11-12',
  },
  ...
  'KS': {
    ...
    backgroundScreening: {
      ...
      validityMonths: 60,
      rescreeningFrequencyMonths: 60,
      stateRegistries: ['KS Nurse Aide Registry'],
      disqualifyingOffenses: ['violent_crimes', 'elder_abuse'],
      requiresLiveScan: false,
    },
    caregiverCredentialing: {
    ...
    regulatory: {
      primaryAgency: 'Kansas Department for Aging and Disability Services',
      agencyWebsite: 'https://www.kdads.ks.gov',
      licenseTypes: ['Home Health Agency'],
      keyRegulations: ['KAR 28-39'],
      auditFrequencyMonths: 36,
      incidentReportingHours: 24,
      seriousIncidentReportingHours: 2,
      clientRightsPostingRequired: true,
      medicaidWaiverPrograms: ['Frail Elderly Waiver', 'PD Waiver'],
    },
    lastUpdated: '2025-11-12',
  },
  ...
  'KY': {
    ...
    backgroundScreening: {
      ...
      validityMonths: 60,
      rescreeningFrequencyMonths: 60,
      stateRegistries: ['KY Nurse Aide Registry'],
      disqualifyingOffenses: ['violent_crimes', 'elder_abuse'],
      requiresLiveScan: false,
    },
    caregiverCredentialing: {
    ...
    regulatory: {
      primaryAgency: 'Kentucky Cabinet for Health and Family Services',
      agencyWebsite: 'https://chfs.ky.gov',
      licenseTypes: ['Home Health Agency'],
      keyRegulations: ['902 KAR 20:066'],
      auditFrequencyMonths: 36,
      incidentReportingHours: 24,
      seriousIncidentReportingHours: 2,
      clientRightsPostingRequired: true,
      medicaidWaiverPrograms: ['Home and Community Based Waiver', 'Supports for Community Living Waiver'],
    },
    lastUpdated: '2025-11-12',
  },
  ...
  'LA': {
    ...
    backgroundScreening: {
      ...
      validityMonths: 60,
      rescreeningFrequencyMonths: 60,
      stateRegistries: ['LA Nurse Aide Registry'],
      disqualifyingOffenses: ['violent_crimes', 'elder_abuse'],
      requiresLiveScan: false,
    },
    caregiverCredentialing: {
    ...
    regulatory: {
      primaryAgency: 'Louisiana Department of Health',
      agencyWebsite: 'https://ldh.la.gov',
      licenseTypes: ['Home Health Agency'],
      keyRegulations: ['LA Admin. Code Title 48'],
      auditFrequencyMonths: 36,
      incidentReportingHours: 24,
      seriousIncidentReportingHours: 2,
      clientRightsPostingRequired: true,
      medicaidWaiverPrograms: ['New Opportunities Waiver', 'Community Choices Waiver'],
    },
    lastUpdated: '2025-11-12',
  },
  ...
  'ME': {
    ...
    backgroundScreening: {
      ...
      validityMonths: 60,
      rescreeningFrequencyMonths: 60,
      stateRegistries: ['ME Nurse Aide Registry'],
      disqualifyingOffenses: ['violent_crimes', 'elder_abuse'],
      requiresLiveScan: false,
    },
    caregiverCredentialing: {
    ...
    regulatory: {
      ...
      licenseTypes: ['Home Health Agency'],
      keyRegulations: ['10-144 CMR Chapter 113'],
      auditFrequencyMonths: 36,
      incidentReportingHours: 24,
      seriousIncidentReportingHours: 2,
      clientRightsPostingRequired: true,
      medicaidWaiverPrograms: ['Section 29 Waiver', 'Section 21 Waiver'],
    },
    lastUpdated: '2025-11-12',
    notes: 'Rural state with flexible EVV geofencing due to geographic challenges.',
  },
  ...
  'MD': {
    ...
    backgroundScreening: {
      ...
      validityMonths: 60,
      rescreeningFrequencyMonths: 60,
      stateRegistries: ['MD Nurse Aide Registry'],
      disqualifyingOffenses: ['violent_crimes', 'elder_abuse'],
      requiresLiveScan: false,
    },
    caregiverCredentialing: {
    ...
    regulatory: {
      primaryAgency: 'Maryland Department of Health',
      agencyWebsite: 'https://health.maryland.gov',
      licenseTypes: ['Home Health Agency'],
      keyRegulations: ['COMAR 10.07.10'],
      auditFrequencyMonths: 36,
      incidentReportingHours: 24,
      seriousIncidentReportingHours: 2,
      clientRightsPostingRequired: true,
      medicaidWaiverPrograms: ['Community Options Waiver', 'Older Adults Waiver'],
    },
    lastUpdated: '2025-11-12',
  },
  ...
  'MA': {
    ...
    backgroundScreening: {
      requiredScreenings: ['FBI_Fingerprint', 'State_Criminal', 'Sex_Offender_Registry'],
      validityMonths: 36,
      rescreeningFrequencyMonths: 36,
      stateRegistries: ['MA Nurse Aide Registry', 'MA CORI'],
      disqualifyingOffenses: ['violent_crimes', 'sex_offenses', 'elder_abuse'],
      requiresLiveScan: false,
    },
    caregiverCredentialing: {
    ...
    regulatory: {
      primaryAgency: 'Massachusetts Department of Public Health',
      agencyWebsite: 'https://www.mass.gov/dph',
      licenseTypes: ['Home Health Agency', 'Homemaker Agency'],
      keyRegulations: ['105 CMR 140.000'],
      auditFrequencyMonths: 36,
      incidentReportingHours: 24,
      seriousIncidentReportingHours: 2,
      clientRightsPostingRequired: true,
      medicaidWaiverPrograms: ['Frail Elder Waiver', 'Adult Supportive Day Program'],
    },
    lastUpdated: '2025-11-12',
    notes: 'MA requires CORI (Criminal Offender Record Information) checks, stricter rescreening (36 months).',
  },
  ...
  'MI': {
    ...
    backgroundScreening: {
      ...
      validityMonths: 60,
      rescreeningFrequencyMonths: 60,
      stateRegistries: ['MI Nurse Aide Registry'],
      disqualifyingOffenses: ['violent_crimes', 'elder_abuse'],
      requiresLiveScan: false,
    },
    caregiverCredentialing: {
    ...
    regulatory: {
      primaryAgency: 'Michigan Department of Health and Human Services',
      agencyWebsite: 'https://www.michigan.gov/mdhhs',
      licenseTypes: ['Home Health Agency'],
      keyRegulations: ['MCL 333.20106'],
      auditFrequencyMonths: 36,
      incidentReportingHours: 24,
      seriousIncidentReportingHours: 2,
      clientRightsPostingRequired: true,
      medicaidWaiverPrograms: ['MI Choice Waiver', 'Habilitation Supports Waiver'],
    },
    lastUpdated: '2025-11-12',
  },
  ...
  'MN': {
    ...
    backgroundScreening: {
      ...
      validityMonths: 60,
      rescreeningFrequencyMonths: 60,
      stateRegistries: ['MN Nurse Aide Registry'],
      disqualifyingOffenses: ['violent_crimes', 'elder_abuse'],
      requiresLiveScan: false,
    },
    caregiverCredentialing: {
    ...
    regulatory: {
      primaryAgency: 'Minnesota Department of Health',
      agencyWebsite: 'https://www.health.state.mn.us',
      licenseTypes: ['Home Care Provider'],
      keyRegulations: ['MN Stat. § 144A.44'],
      auditFrequencyMonths: 36,
      incidentReportingHours: 24,
      seriousIncidentReportingHours: 2,
      clientRightsPostingRequired: true,
      medicaidWaiverPrograms: ['Elderly Waiver', 'Community Alternative Care Waiver'],
    },
    lastUpdated: '2025-11-12',
  },
  ...
  'MS': {
    ...
    backgroundScreening: {
      ...
      validityMonths: 60,
      rescreeningFrequencyMonths: 60,
      stateRegistries: ['MS Nurse Aide Registry'],
      disqualifyingOffenses: ['violent_crimes', 'elder_abuse'],
      requiresLiveScan: false,
    },
    caregiverCredentialing: {
    ...
    regulatory: {
      ...
      agencyWebsite: 'https://msdh.ms.gov',
      licenseTypes: ['Home Health Agency'],
      keyRegulations: ['MS Code § 41-71-1'],
      auditFrequencyMonths: 36,
      incidentReportingHours: 24,
      seriousIncidentReportingHours: 2,
      clientRightsPostingRequired: true,
      medicaidWaiverPrograms: ['Elderly and Disabled Waiver', 'Independent Living Waiver'],
    },
    lastUpdated: '2025-11-12',
  },
  ...
  'MO': {
    ...
    backgroundScreening: {
      ...
      validityMonths: 60,
      rescreeningFrequencyMonths: 60,
      stateRegistries: ['MO Nurse Aide Registry'],
      disqualifyingOffenses: ['violent_crimes', 'elder_abuse'],
      requiresLiveScan: false,
    },
    caregiverCredentialing: {
    ...
    regulatory: {
      ...
      agencyWebsite: 'https://health.mo.gov',
      licenseTypes: ['Home Health Agency'],
      keyRegulations: ['19 CSR 30-81'],
      auditFrequencyMonths: 36,
      incidentReportingHours: 24,
      seriousIncidentReportingHours: 2,
      clientRightsPostingRequired: true,
      medicaidWaiverPrograms: ['Aged and Disabled Waiver', 'Community Support Waiver'],
    },
    lastUpdated: '2025-11-12',
  },
  ...
  'MT': {
    ...
    backgroundScreening: {
      ...
      validityMonths: 60,
      rescreeningFrequencyMonths: 60,
      stateRegistries: ['MT Nurse Aide Registry'],
      disqualifyingOffenses: ['violent_crimes', 'elder_abuse'],
      requiresLiveScan: false,
    },
    caregiverCredentialing: {
    ...
    regulatory: {
      primaryAgency: 'Montana Department of Public Health and Human Services',
      agencyWebsite: 'https://dphhs.mt.gov',
      licenseTypes: ['Home Health Agency'],
      keyRegulations: ['ARM 37.106'],
      auditFrequencyMonths: 36,
      incidentReportingHours: 24,
      seriousIncidentReportingHours: 2,
      clientRightsPostingRequired: true,
      medicaidWaiverPrograms: ['Big Sky Waiver', '0208 Waiver'],
    },
    lastUpdated: '2025-11-12',
    notes: 'Rural state with flexible EVV due to large service areas and connectivity challenges.',
  },
  ...
  'NE': {
    ...
    backgroundScreening: {
      ...
      validityMonths: 60,
      rescreeningFrequencyMonths: 60,
      stateRegistries: ['NE Nurse Aide Registry'],
      disqualifyingOffenses: ['violent_crimes', 'elder_abuse'],
      requiresLiveScan: false,
    },
    caregiverCredentialing: {
    ...
    regulatory: {
      primaryAgency: 'Nebraska Department of Health and Human Services',
      agencyWebsite: 'https://dhhs.ne.gov',
      licenseTypes: ['Home Health Agency'],
      keyRegulations: ['175 NAC 11'],
      auditFrequencyMonths: 36,
      incidentReportingHours: 24,
      seriousIncidentReportingHours: 2,
      clientRightsPostingRequired: true,
      medicaidWaiverPrograms: ['Aged and Disabled Waiver', 'DD Services Waiver'],
    },
    lastUpdated: '2025-11-12',
  },
  ...
  'NV': {
    ...
    backgroundScreening: {
      ...
      validityMonths: 60,
      rescreeningFrequencyMonths: 60,
      stateRegistries: ['NV Nurse Aide Registry'],
      disqualifyingOffenses: ['violent_crimes', 'elder_abuse'],
      requiresLiveScan: false,
    },
    caregiverCredentialing: {
    ...
    regulatory: {
      primaryAgency: 'Nevada Division of Public and Behavioral Health',
      agencyWebsite: 'https://dpbh.nv.gov',
      licenseTypes: ['Home Health Agency'],
      keyRegulations: ['NAC 449'],
      auditFrequencyMonths: 36,
      incidentReportingHours: 24,
      seriousIncidentReportingHours: 2,
      clientRightsPostingRequired: true,
      medicaidWaiverPrograms: ['Frail Elderly Services Program', 'Rural Hospital Grant Program'],
    },
    lastUpdated: '2025-11-12',
  },
  ...
  'NH': {
    ...
    backgroundScreening: {
      ...
      validityMonths: 60,
      rescreeningFrequencyMonths: 60,
      stateRegistries: ['NH Nurse Aide Registry'],
      disqualifyingOffenses: ['violent_crimes', 'elder_abuse'],
      requiresLiveScan: false,
    },
    caregiverCredentialing: {
    ...
    regulatory: {
      primaryAgency: 'New Hampshire Department of Health and Human Services',
      agencyWebsite: 'https://www.dhhs.nh.gov',
      licenseTypes: ['Home Health Care Provider'],
      keyRegulations: ['He-P 809'],
      auditFrequencyMonths: 36,
      incidentReportingHours: 24,
      seriousIncidentReportingHours: 2,
      clientRightsPostingRequired: true,
      medicaidWaiverPrograms: ['Choices for Independence Waiver', 'In-Home Supports Waiver'],
    },
    lastUpdated: '2025-11-12',
  },
  ...
  'NJ': {
    ...
    backgroundScreening: {
      ...
      validityMonths: 24,
      rescreeningFrequencyMonths: 24,
      stateRegistries: ['NJ Nurse Aide Registry'],
      disqualifyingOffenses: ['violent_crimes', 'elder_abuse'],
      requiresLiveScan: false,
    },
    caregiverCredentialing: {
      nurseAideRegistryRequired: true,
      minimumTrainingHours: 76,
      competencyEvaluationRequired: true,
      annualTrainingHours: 12,
      requiredCertifications: ['CPR', 'First Aid'],
      medicationDelegationAllowed: true,
    ...
    regulatory: {
      primaryAgency: 'New Jersey Department of Health',
      agencyWebsite: 'https://www.nj.gov/health',
      licenseTypes: ['Home Health Agency', 'Assisted Living Residence'],
      keyRegulations: ['N.J.A.C. 8:42'],
      auditFrequencyMonths: 24,
      incidentReportingHours: 24,
      seriousIncidentReportingHours: 2,
      clientRightsPostingRequired: true,
      medicaidWaiverPrograms: ['Global Options Waiver', 'Community Care Waiver'],
    },
    lastUpdated: '2025-11-12',
    notes: 'NJ requires more frequent rescreening (24 months) and more frequent audits.',
  },
  ...
  'NM': {
    ...
    backgroundScreening: {
      ...
      validityMonths: 60,
      rescreeningFrequencyMonths: 60,
      stateRegistries: ['NM Nurse Aide Registry'],
      disqualifyingOffenses: ['violent_crimes', 'elder_abuse'],
      requiresLiveScan: false,
    },
    caregiverCredentialing: {
    ...
    regulatory: {
      primaryAgency: 'New Mexico Department of Health',
      agencyWebsite: 'https://www.nmhealth.org',
      licenseTypes: ['Home Health Agency'],
      keyRegulations: ['7.28.2 NMAC'],
      auditFrequencyMonths: 36,
      incidentReportingHours: 24,
      seriousIncidentReportingHours: 2,
      clientRightsPostingRequired: true,
      medicaidWaiverPrograms: ['Mi Via Waiver', 'DD Waiver'],
    },
    lastUpdated: '2025-11-12',
  },
  ...
  'NY': {
    ...
    evv: {
      ...
      additionalDataElements: ['service_authorization_id'],
      visitCorrection: {
        caregiverCanCorrect: false,
        correctionWindowHours: 24,
        requiresSupervisorApproval: true,
    ...
    backgroundScreening: {
      ...
      validityMonths: 36,
      rescreeningFrequencyMonths: 36,
      stateRegistries: ['NY Nurse Aide Registry', 'NY Justice Center Registry'],
      disqualifyingOffenses: ['violent_crimes', 'sex_offenses', 'elder_abuse', 'financial_exploitation'],
      requiresLiveScan: false,
    },
    caregiverCredentialing: {
      nurseAideRegistryRequired: true,
      ...
      competencyEvaluationRequired: true,
      annualTrainingHours: 12,
      requiredCertifications: ['CPR', 'First Aid', 'Infection Control'],
      medicationDelegationAllowed: false,
    },
    planOfCare: {
      skilledNursingReviewDays: 60,
      personalCareReviewDays: 90,
    ...
    regulatory: {
      primaryAgency: 'New York State Department of Health',
      agencyWebsite: 'https://www.health.ny.gov',
      licenseTypes: ['Licensed Home Care Services Agency (LHCSA)', 'Certified Home Health Agency (CHHA)'],
      keyRegulations: ['10 NYCRR Part 763', '10 NYCRR Part 766'],
      auditFrequencyMonths: 36,
      incidentReportingHours: 24,
      seriousIncidentReportingHours: 2,
      clientRightsPostingRequired: true,
      medicaidWaiverPrograms: ['Nursing Home Transition and Diversion Waiver', 'TBI Waiver'],
    },
    lastUpdated: '2025-11-12',
    notes: 'NY has strict Justice Center reporting requirements, higher training hours, medication delegation very restricted.',
  },
  ...
  'NC': {
    ...
    backgroundScreening: {
      ...
      validityMonths: 60,
      rescreeningFrequencyMonths: 60,
      stateRegistries: ['NC Nurse Aide Registry'],
      disqualifyingOffenses: ['violent_crimes', 'elder_abuse'],
      requiresLiveScan: false,
    },
    caregiverCredentialing: {
    ...
    regulatory: {
      primaryAgency: 'North Carolina Division of Health Service Regulation',
      agencyWebsite: 'https://www.ncdhhs.gov',
      licenseTypes: ['Home Care Agency'],
      keyRegulations: ['10A NCAC 13F'],
      auditFrequencyMonths: 36,
      incidentReportingHours: 24,
      seriousIncidentReportingHours: 2,
      clientRightsPostingRequired: true,
      medicaidWaiverPrograms: ['CAP/DA Waiver', 'CAP/C Waiver'],
    },
    lastUpdated: '2025-11-12',
  },
  ...
  'ND': {
    ...
    backgroundScreening: {
      ...
      validityMonths: 60,
      rescreeningFrequencyMonths: 60,
      stateRegistries: ['ND Nurse Aide Registry'],
      disqualifyingOffenses: ['violent_crimes', 'elder_abuse'],
      requiresLiveScan: false,
    },
    caregiverCredentialing: {
    ...
    regulatory: {
      primaryAgency: 'North Dakota Department of Health',
      agencyWebsite: 'https://www.health.nd.gov',
      licenseTypes: ['Home Health Agency'],
      keyRegulations: ['NDCC 23-17.3'],
      auditFrequencyMonths: 36,
      incidentReportingHours: 24,
      seriousIncidentReportingHours: 2,
      clientRightsPostingRequired: true,
    ...
    lastUpdated: '2025-11-12',
    notes: 'Rural state with flexible EVV requirements.',
  },
  ...
  'OH': {
    ...
    backgroundScreening: {
      ...
      validityMonths: 60,
      rescreeningFrequencyMonths: 60,
      stateRegistries: ['OH Nurse Aide Registry'],
      disqualifyingOffenses: ['violent_crimes', 'elder_abuse'],
      requiresLiveScan: false,
    },
    caregiverCredentialing: {
    ...
    regulatory: {
      primaryAgency: 'Ohio Department of Health',
      agencyWebsite: 'https://odh.ohio.gov',
      licenseTypes: ['Home Health Agency'],
      keyRegulations: ['ORC 3701.881'],
      auditFrequencyMonths: 36,
      incidentReportingHours: 24,
      seriousIncidentReportingHours: 2,
      clientRightsPostingRequired: true,
      medicaidWaiverPrograms: ['PASSPORT Waiver', 'Assisted Living Waiver'],
    },
    lastUpdated: '2025-11-12',
  },
  ...
  'OK': {
    ...
    backgroundScreening: {
      ...
      validityMonths: 60,
      rescreeningFrequencyMonths: 60,
      stateRegistries: ['OK Nurse Aide Registry'],
      disqualifyingOffenses: ['violent_crimes', 'elder_abuse'],
      requiresLiveScan: false,
    },
    caregiverCredentialing: {
    ...
    regulatory: {
      primaryAgency: 'Oklahoma State Department of Health',
      agencyWebsite: 'https://oklahoma.gov/health.html',
      licenseTypes: ['Home Health Agency'],
      keyRegulations: ['OAC 310:667'],
      auditFrequencyMonths: 36,
      incidentReportingHours: 24,
      seriousIncidentReportingHours: 2,
      clientRightsPostingRequired: true,
      medicaidWaiverPrograms: ['ADvantage Waiver', 'In-Home Support Waiver'],
    },
    lastUpdated: '2025-11-12',
  },
  ...
  'OR': {
    ...
    backgroundScreening: {
      ...
      validityMonths: 60,
      rescreeningFrequencyMonths: 60,
      stateRegistries: ['OR Nurse Aide Registry'],
      disqualifyingOffenses: ['violent_crimes', 'elder_abuse'],
      requiresLiveScan: false,
    },
    caregiverCredentialing: {
    ...
    regulatory: {
      primaryAgency: 'Oregon Health Authority',
      agencyWebsite: 'https://www.oregon.gov/oha',
      licenseTypes: ['Home Health Agency'],
      keyRegulations: ['OAR 333-536'],
      auditFrequencyMonths: 36,
      incidentReportingHours: 24,
      seriousIncidentReportingHours: 2,
      clientRightsPostingRequired: true,
      medicaidWaiverPrograms: ['K Plan Waiver', 'Community First Choice'],
    },
    lastUpdated: '2025-11-12',
  },
  ...
  'PA': {
    ...
    backgroundScreening: {
      ...
      validityMonths: 60,
      rescreeningFrequencyMonths: 60,
      stateRegistries: ['PA Nurse Aide Registry'],
    ...
    regulatory: {
      primaryAgency: 'Pennsylvania Department of Health',
      agencyWebsite: 'https://www.health.pa.gov',
      licenseTypes: ['Home Health Agency'],
      keyRegulations: ['28 Pa. Code § 51'],
      auditFrequencyMonths: 36,
      incidentReportingHours: 24,
      seriousIncidentReportingHours: 2,
      clientRightsPostingRequired: true,
      medicaidWaiverPrograms: ['OBRA Waiver', 'Aging Waiver'],
    },
    lastUpdated: '2025-11-12',
  },
  ...
  'RI': {
    ...
    backgroundScreening: {
      ...
      validityMonths: 60,
      rescreeningFrequencyMonths: 60,
      stateRegistries: ['RI Nurse Aide Registry'],
      disqualifyingOffenses: ['violent_crimes', 'elder_abuse'],
      requiresLiveScan: false,
    },
    caregiverCredentialing: {
    ...
    regulatory: {
      ...
      agencyWebsite: 'https://health.ri.gov',
      licenseTypes: ['Home Care Provider'],
      keyRegulations: ['R23-17.4-HMH'],
      auditFrequencyMonths: 36,
      incidentReportingHours: 24,
      seriousIncidentReportingHours: 2,
      clientRightsPostingRequired: true,
      medicaidWaiverPrograms: ['Community Services for Persons with Developmental Disabilities'],
    },
    lastUpdated: '2025-11-12',
  },
  ...
  'SC': {
    ...
    backgroundScreening: {
      ...
      validityMonths: 60,
      rescreeningFrequencyMonths: 60,
      stateRegistries: ['SC Nurse Aide Registry'],
      disqualifyingOffenses: ['violent_crimes', 'elder_abuse'],
      requiresLiveScan: false,
    },
    caregiverCredentialing: {
    ...
    regulatory: {
      primaryAgency: 'South Carolina Department of Health and Environmental Control',
      agencyWebsite: 'https://scdhec.gov',
      licenseTypes: ['Home Health Agency'],
      keyRegulations: ['SC Code § 44-69'],
      auditFrequencyMonths: 36,
      incidentReportingHours: 24,
      seriousIncidentReportingHours: 2,
      clientRightsPostingRequired: true,
      medicaidWaiverPrograms: ['Community Choices Waiver', 'Pervasive Developmental Disorder/Autism Waiver'],
    },
    lastUpdated: '2025-11-12',
  },
  ...
  'SD': {
    ...
    backgroundScreening: {
      ...
      validityMonths: 60,
      rescreeningFrequencyMonths: 60,
      stateRegistries: ['SD Nurse Aide Registry'],
      disqualifyingOffenses: ['violent_crimes', 'elder_abuse'],
      requiresLiveScan: false,
    },
    caregiverCredentialing: {
    ...
    regulatory: {
      primaryAgency: 'South Dakota Department of Health',
      agencyWebsite: 'https://doh.sd.gov',
      licenseTypes: ['Home Health Agency'],
      keyRegulations: ['ARSD 44:75'],
      auditFrequencyMonths: 36,
      incidentReportingHours: 24,
      seriousIncidentReportingHours: 2,
      clientRightsPostingRequired: true,
      medicaidWaiverPrograms: ['Supportive Home Care Waiver'],
    },
    lastUpdated: '2025-11-12',
    notes: 'Rural state with flexible EVV.',
  },
  ...
  'TN': {
    ...
    backgroundScreening: {
      ...
      validityMonths: 60,
      rescreeningFrequencyMonths: 60,
      stateRegistries: ['TN Nurse Aide Registry'],
      disqualifyingOffenses: ['violent_crimes', 'elder_abuse'],
      requiresLiveScan: false,
    },
    caregiverCredentialing: {
    ...
    regulatory: {
      primaryAgency: 'Tennessee Department of Health',
      agencyWebsite: 'https://www.tn.gov/health',
      licenseTypes: ['Home Care Agency'],
      keyRegulations: ['TN Code § 68-11-201'],
      auditFrequencyMonths: 36,
      incidentReportingHours: 24,
      seriousIncidentReportingHours: 2,
      clientRightsPostingRequired: true,
      medicaidWaiverPrograms: ['CHOICES Waiver', 'ECF CHOICES Waiver'],
    },
    lastUpdated: '2025-11-12',
  },
  ...
  'UT': {
    ...
    backgroundScreening: {
      ...
      validityMonths: 60,
      rescreeningFrequencyMonths: 60,
      stateRegistries: ['UT Nurse Aide Registry'],
      disqualifyingOffenses: ['violent_crimes', 'elder_abuse'],
      requiresLiveScan: false,
    },
    caregiverCredentialing: {
    ...
    regulatory: {
      primaryAgency: 'Utah Department of Health',
      agencyWebsite: 'https://health.utah.gov',
      licenseTypes: ['Home Health Agency'],
      keyRegulations: ['R432-700'],
      auditFrequencyMonths: 36,
      incidentReportingHours: 24,
      seriousIncidentReportingHours: 2,
      clientRightsPostingRequired: true,
      medicaidWaiverPrograms: ['New Choices Waiver', 'Community Supports Waiver'],
    },
    lastUpdated: '2025-11-12',
  },
  ...
  'VT': {
    ...
    backgroundScreening: {
      ...
      validityMonths: 60,
      rescreeningFrequencyMonths: 60,
      stateRegistries: ['VT Nurse Aide Registry'],
      disqualifyingOffenses: ['violent_crimes', 'elder_abuse'],
      requiresLiveScan: false,
    },
    caregiverCredentialing: {
    ...
    regulatory: {
      primaryAgency: 'Vermont Department of Disabilities, Aging and Independent Living',
      agencyWebsite: 'https://dail.vermont.gov',
      licenseTypes: ['Home Health Agency'],
      keyRegulations: ['33 VSA § 901'],
      auditFrequencyMonths: 36,
      incidentReportingHours: 24,
      seriousIncidentReportingHours: 2,
      clientRightsPostingRequired: true,
      medicaidWaiverPrograms: ['High and Highest Needs Waiver', 'Developmental Disabilities Services Waiver'],
    },
    lastUpdated: '2025-11-12',
    notes: 'Rural state with flexible EVV geofencing requirements.',
  },
  ...
  'VA': {
    ...
    backgroundScreening: {
      ...
      validityMonths: 60,
      rescreeningFrequencyMonths: 60,
      stateRegistries: ['VA Nurse Aide Registry'],
      disqualifyingOffenses: ['violent_crimes', 'elder_abuse'],
      requiresLiveScan: false,
    },
    caregiverCredentialing: {
    ...
    regulatory: {
      primaryAgency: 'Virginia Department of Health',
      agencyWebsite: 'https://www.vdh.virginia.gov',
      licenseTypes: ['Home Health Agency'],
      keyRegulations: ['12 VAC 5-391'],
      auditFrequencyMonths: 36,
      incidentReportingHours: 24,
      seriousIncidentReportingHours: 2,
      clientRightsPostingRequired: true,
      medicaidWaiverPrograms: ['Commonwealth Coordinated Care Plus Waiver', 'FIS Waiver'],
    },
    lastUpdated: '2025-11-12',
  },
  ...
  'WA': {
    ...
    backgroundScreening: {
      ...
      validityMonths: 60,
      rescreeningFrequencyMonths: 60,
      stateRegistries: ['WA Nurse Aide Registry', 'WA DSHS Background Check Central Unit'],
      disqualifyingOffenses: ['violent_crimes', 'sex_offenses', 'elder_abuse'],
      requiresLiveScan: false,
    },
    caregiverCredentialing: {
    ...
    regulatory: {
      primaryAgency: 'Washington State Department of Health',
      agencyWebsite: 'https://www.doh.wa.gov',
      licenseTypes: ['Home Health Agency', 'Home Care Agency'],
      keyRegulations: ['WAC 246-335'],
      auditFrequencyMonths: 36,
      incidentReportingHours: 24,
      seriousIncidentReportingHours: 2,
      clientRightsPostingRequired: true,
      medicaidWaiverPrograms: ['Community First Choice', 'New Freedom Waiver'],
    },
    lastUpdated: '2025-11-12',
  },
  ...
  'WV': {
    ...
    backgroundScreening: {
      ...
      validityMonths: 60,
      rescreeningFrequencyMonths: 60,
      stateRegistries: ['WV Nurse Aide Registry'],
      disqualifyingOffenses: ['violent_crimes', 'elder_abuse'],
      requiresLiveScan: false,
    },
    caregiverCredentialing: {
    ...
    regulatory: {
      primaryAgency: 'West Virginia Department of Health and Human Resources',
      agencyWebsite: 'https://dhhr.wv.gov',
      licenseTypes: ['Home Health Agency'],
      keyRegulations: ['WV Code § 16-5H'],
      auditFrequencyMonths: 36,
      incidentReportingHours: 24,
      seriousIncidentReportingHours: 2,
      clientRightsPostingRequired: true,
      medicaidWaiverPrograms: ['Aged and Disabled Waiver', 'Intellectual/Developmental Disabilities Waiver'],
    },
    lastUpdated: '2025-11-12',
  },
  ...
  'WI': {
    ...
    backgroundScreening: {
      requiredScreenings: ['FBI_Fingerprint', 'State_Criminal'],
      validityMonths: 48,
      rescreeningFrequencyMonths: 48,
      stateRegistries: ['WI Nurse Aide Registry'],
      disqualifyingOffenses: ['violent_crimes', 'elder_abuse'],
      requiresLiveScan: false,
    },
    caregiverCredentialing: {
    ...
    regulatory: {
      primaryAgency: 'Wisconsin Department of Health Services',
      agencyWebsite: 'https://www.dhs.wisconsin.gov',
      licenseTypes: ['Home Health Agency'],
      keyRegulations: ['WI Stat. § 50.49'],
      auditFrequencyMonths: 36,
      incidentReportingHours: 24,
      seriousIncidentReportingHours: 2,
      clientRightsPostingRequired: true,
      medicaidWaiverPrograms: ['Family Care', 'IRIS (Include, Respect, I Self-Direct)'],
    },
    lastUpdated: '2025-11-12',
    notes: 'WI requires 120 hours of training (higher than federal minimum) and more frequent rescreening (48 months).',
  },
  ...
  'WY': {
    ...
    backgroundScreening: {
      ...
      validityMonths: 60,
      rescreeningFrequencyMonths: 60,
      stateRegistries: ['WY Nurse Aide Registry'],
      disqualifyingOffenses: ['violent_crimes', 'elder_abuse'],
      requiresLiveScan: false,
    },
    caregiverCredentialing: {
    ...
    regulatory: {
      primaryAgency: 'Wyoming Department of Health',
      agencyWebsite: 'https://health.wyo.gov',
      licenseTypes: ['Home Health Agency'],
      keyRegulations: ['WY Stat. § 35-2-901'],
      auditFrequencyMonths: 36,
      incidentReportingHours: 24,
      seriousIncidentReportingHours: 2,
      clientRightsPostingRequired: true,
      medicaidWaiverPrograms: ['Acquired Brain Injury Waiver', 'Supports Waiver'],
    },
    lastUpdated: '2025-11-12',
    notes: 'Most rural state - flexible EVV geofencing due to vast distances and connectivity challenges.',
  },
};
