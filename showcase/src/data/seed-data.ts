...
// Date-only strings for time concatenation (YYYY-MM-DD format)
...
export const tasks: TaskInstance[] = [
  // Tasks for client-001 (Margaret Thompson)
  {
    ...
    status: 'SCHEDULED',
    priority: 'MEDIUM',
    scheduledStartTime: tomorrowDate + 'T08:00:00Z',
    scheduledEndTime: tomorrowDate + 'T08:30:00Z',
  ...
  },
  {
    ...
    status: 'COMPLETED',
    priority: 'MEDIUM',
    scheduledStartTime: yesterdayDate + 'T10:00:00Z',
    scheduledEndTime: yesterdayDate + 'T10:15:00Z',
    completedAt: yesterdayDate + 'T10:20:00Z',
  ...
  // Tasks for client-002 (Robert Chen)
  {
    ...
    status: 'SCHEDULED',
    priority: 'HIGH',
    scheduledStartTime: tomorrowDate + 'T07:00:00Z',
    scheduledEndTime: tomorrowDate + 'T07:15:00Z',
    requiresSignature: true,
    requiresEvv: true,
    createdAt: yesterday,
    updatedAt: yesterday,
  },
  {
    ...
    status: 'COMPLETED',
    priority: 'HIGH',
    scheduledStartTime: yesterdayDate + 'T07:00:00Z',
    scheduledEndTime: yesterdayDate + 'T07:10:00Z',
    completedAt: yesterdayDate + 'T07:05:00Z',
  ...
  // Tasks for client-003 (Dorothy Williams)
  {
    ...
    status: 'SCHEDULED',
    priority: 'MEDIUM',
    scheduledStartTime: tomorrowDate + 'T14:00:00Z',
    scheduledEndTime: tomorrowDate + 'T15:00:00Z',
  ...
  },
  {
    ...
    status: 'COMPLETED',
    priority: 'MEDIUM',
    scheduledStartTime: yesterdayDate + 'T12:00:00Z',
    scheduledEndTime: yesterdayDate + 'T12:30:00Z',
    completedAt: yesterdayDate + 'T12:25:00Z',
  ...
  // Tasks for client-004 (George Martinez)
  {
    ...
    status: 'SCHEDULED',
    priority: 'URGENT',
    scheduledStartTime: tomorrowDate + 'T09:00:00Z',
    scheduledEndTime: tomorrowDate + 'T09:30:00Z',
    requiresSignature: true,
    requiresEvv: true,
    createdAt: yesterday,
    updatedAt: yesterday,
  },
  {
    ...
    status: 'COMPLETED',
    priority: 'HIGH',
    scheduledStartTime: yesterdayDate + 'T20:00:00Z',
    scheduledEndTime: yesterdayDate + 'T20:10:00Z',
    completedAt: yesterdayDate + 'T20:05:00Z',
...
export const shiftListings: ShiftListing[] = [
  {
    ...
    startTime: tomorrowDate + 'T07:00:00Z',
    endTime: tomorrowDate + 'T11:00:00Z',
    status: 'OPEN',
  ...
  },
  {
    ...
    startTime: tomorrowDate + 'T17:00:00Z',
    endTime: tomorrowDate + 'T21:00:00Z',
    status: 'FILLED',
    assignedCaregiverId: 'caregiver-002',
